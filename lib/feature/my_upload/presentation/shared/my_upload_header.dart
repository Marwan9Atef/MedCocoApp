...
import 'package:medcoco/feature/my_upload/presentation/shared/desktop_refresh_indicator.dart';
    ...
    return Row(
      children: [
        ...
        height: 8,
            ...
            Text("$numberOfImages image uploaded",style: AppStyles.styleRegular16(context).copyWith(color: AppColor.gray),),
                    const SizedBox(
        height: 8,
